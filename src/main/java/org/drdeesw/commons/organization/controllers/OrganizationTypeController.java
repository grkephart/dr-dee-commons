...
@RestController
@Validated
public class OrganizationTypeController extends AbstractCrudController<OrganizationTypePojo, Long>
{
  private static final String SECURE_PREFIX         = "/secure";
  private static final String MAPPING_PREFIX        = "/organization_types";
  ...
  public QueryResults<OrganizationTypePojo> findByQuery(
    @RequestParam
  ...
  public ResponseEntity<OrganizationTypePojo> get(
    @PathVariable
    Long id)
  {
    return super.get(id);
