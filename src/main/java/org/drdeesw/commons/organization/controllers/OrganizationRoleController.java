...
@RestController
@Validated
public class OrganizationRoleController extends AbstractCrudController<OrganizationRolePojo, Long>
{
  private static final String SECURE_PREFIX         = "/secure";
  private static final String MAPPING_PREFIX        = "/organization_roles";
