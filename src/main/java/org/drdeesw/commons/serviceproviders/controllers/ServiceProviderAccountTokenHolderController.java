 ...
 */
public class ServiceProviderAccountTokenHolderController
    extends AbstractCrudController<ServiceProviderAccountTokenHolderPojo, Long>
{
  private static final String                      MAPPING_PREFIX      = "/tokenholders";
  private static final String                      FULL_MAPPING_PREFIX = ServiceProviderAccountController.FULL_MAPPING_PREFIX
                                                                         + MAPPING_PREFIX;
